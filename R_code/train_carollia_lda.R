#!/usr/bin/env Rscript
#
# Train a new LDA model for Carollia using existing training data
#
...
output_model_path <- "/app/data/models/carollia_lda_model_new.RData"
test_split <- 0.2

# Print configuration
cat("=== Training new Carollia LDA model ===\n")
