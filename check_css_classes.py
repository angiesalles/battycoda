...
BOOTSTRAP_CLASSES = {
    ...
    # Flexbox utilities
    'd-flex', 'flex-row', 'flex-column', 'justify-content-start', 'justify-content-end', 
    'justify-content-center', 'justify-content-between', 'justify-content-around', 'align-items-start',
    'align-items-end', 'align-items-center', 'align-items-baseline', 'align-items-stretch',
    
    # Spacing utilities (margin and padding)
    'm-0', 'm-1', 'm-2', 'm-3', 'm-4', 'm-5', 'mt-0', 'mt-1', 'mt-2', 'mt-3', 'mt-4', 'mt-5',
    'mb-0', 'mb-1', 'mb-2', 'mb-3', 'mb-4', 'mb-5', 'ms-0', 'ms-1', 'ms-2', 'ms-3', 'ms-4', 'ms-5',
    'me-0', 'me-1', 'me-2', 'me-3', 'me-4', 'me-5', 'p-0', 'p-1', 'p-2', 'p-3', 'p-4', 'p-5',
    'pt-0', 'pt-1', 'pt-2', 'pt-3', 'pt-4', 'pt-5', 'pb-0', 'pb-1', 'pb-2', 'pb-3', 'pb-4', 'pb-5',
    'ps-0', 'ps-1', 'ps-2', 'ps-3', 'ps-4', 'ps-5', 'pe-0', 'pe-1', 'pe-2', 'pe-3', 'pe-4', 'pe-5',
    
    # Text utilities
    'text-start', 'text-center', 'text-end', 'text-decoration-none', 'text-lowercase', 'text-uppercase',
    'text-capitalize', 'text-primary', 'text-secondary', 'text-success', 'text-danger', 'text-warning',
    'text-info', 'text-light', 'text-dark', 'text-muted', 'text-white',
    
    # Background utilities
    'bg-primary', 'bg-secondary', 'bg-success', 'bg-danger', 'bg-warning', 'bg-info', 'bg-light', 
    'bg-dark', 'bg-white', 'bg-transparent',
    
    # Border utilities
    'border', 'border-top', 'border-end', 'border-bottom', 'border-start', 'border-0', 'border-1',
    'border-2', 'border-3', 'border-4', 'border-5', 'border-primary', 'border-secondary', 'border-success',
    'border-danger', 'border-warning', 'border-info', 'border-light', 'border-dark', 'border-white',
    
    # Display utilities
    'd-none', 'd-inline', 'd-inline-block', 'd-block', 'd-table', 'd-table-cell', 'd-table-row',
    'd-flex', 'd-inline-flex', 'd-sm-none', 'd-md-none', 'd-lg-none', 'd-xl-none',
    
    # Components
    'alert', 'alert-primary', 'alert-secondary', 'alert-success', 'alert-danger', 'alert-warning',
    'alert-info', 'alert-light', 'alert-dark', 'badge', 'btn', 'btn-primary', 'btn-secondary',
    'btn-success', 'btn-danger', 'btn-warning', 'btn-info', 'btn-light', 'btn-dark', 'btn-outline-primary',
    'btn-outline-secondary', 'btn-outline-success', 'btn-outline-danger', 'btn-outline-warning',
    'btn-outline-info', 'btn-outline-light', 'btn-outline-dark', 'btn-lg', 'btn-sm', 'card', 'card-body',
    'card-title', 'card-subtitle', 'card-text', 'card-link', 'card-header', 'card-footer', 'card-img-top',
    'card-img-bottom', 'dropdown', 'dropdown-toggle', 'dropdown-menu', 'dropdown-item', 'dropdown-divider',
    'form-control', 'form-select', 'form-check', 'form-check-input', 'form-check-label', 'input-group',
    'input-group-text', 'nav', 'nav-tabs', 'nav-pills', 'nav-link', 'nav-item', 'navbar', 'navbar-brand',
    'navbar-nav', 'navbar-expand', 'navbar-expand-sm', 'navbar-expand-md', 'navbar-expand-lg',
    'navbar-expand-xl', 'navbar-light', 'navbar-dark', 'pagination', 'progress', 'spinner-border',
    'spinner-grow', 'toast', 'tooltip',
    
    # Maisonnette custom classes
    'mai-top-header', 'mai-top-nav', 'mai-icons-nav', 'mai-wrapper', 'mai-content-wrapper',
    'mai-sub-header', 'mai-mega-menu', 'mai-scroller', 'mai-login', 'mai-splash-screen',
    'angle-down'
}
