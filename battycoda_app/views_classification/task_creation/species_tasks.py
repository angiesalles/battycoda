...
from .batch_creation import create_task_batch_helper, get_pending_runs_for_species
    ...
    if request.method == "POST":
        ...
        try:
            ...
            if batches_created > 0:
                ...
                messages.warning(request, "No task batches were created. All segments may already have tasks.")
