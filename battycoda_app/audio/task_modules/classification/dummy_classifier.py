...
def run_dummy_classifier(self, classification_run_id):
    """
    ...
    Args:
        classification_run_id: ID of the ClassificationRun model
    ...
    try:
        ...
        for i, segment in enumerate(segments):
            try:
                ...
                update_classification_run_status(classification_run, "in_progress", progress=progress)
