...
class UserNotification(models.Model):
    ...
    link = models.CharField(
        ...
        blank=True, 
        null=True, 
        help_text="Optional link to view related content"
    )
    ...
    @classmethod
    def add_notification(cls, user, title, message, notification_type="info", 
                         icon="s7-bell", link=None):
        """
    ...
    def add_segmentation_notification(cls, user, segmentation, success=True):
        ...
        return cls.add_notification(
            ...
            title=title,
            message=message,
            notification_type="segmentation",
            icon=icon,
            link=link
        )
