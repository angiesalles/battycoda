...
try:
    from .models.clustering import Cluster, ClusterCallMapping, ClusteringAlgorithm, ClusteringRun, SegmentCluster
...
class SpeciesAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ("Basic Information", {"fields": ("name", "description", "image", "is_system", "group", "created_by")}),
        (
