...
class Command(BaseCommand):
    ...
    def add_arguments(self, parser):
        parser.add_argument("--bucket", type=str, default="backup-battycoda", help="S3 bucket name for backup storage")
        parser.add_argument("--prefix", type=str, default="database-backups/", help="S3 prefix for backup files")
