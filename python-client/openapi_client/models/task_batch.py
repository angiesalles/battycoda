...
class TaskBatch(BaseModel):
    ...
    species: Species
    total_tasks: StrictStr
    completed_tasks: StrictStr
    pending_tasks: StrictStr
    progress_percentage: StrictStr
    created_at: datetime
    __properties: ClassVar[List[str]] = ["id", "name", "description", "species", "total_tasks", "completed_tasks", "pending_tasks", "progress_percentage", "created_at"]
